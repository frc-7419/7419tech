  ...
  return (
    <section className="py-12 bg-gray-50">
      <div className="container px-4 md:px-6 mx-auto">
        <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-12">Our Mentors</h1>
        <div className="flex flex-wrap justify-center gap-8">
          {mentors.map((mentor, index) => (
            <Card key={index} className="overflow-hidden transition-all duration-200 hover:shadow-lg w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1rem)] xl:w-[calc(25%-1rem)] max-w-sm">
              <CardContent className="p-6">
                ...
                <h2 className="text-2xl font-semibold text-center mb-2">{mentor.name}</h2>
